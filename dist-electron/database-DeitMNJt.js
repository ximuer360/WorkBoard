...
const dbPath = isDev ? path.join(process.cwd(), "tasks.db") : path.join(electron.app.getPath("userData"), "tasks.db");
...
const taskDb = {
  ...
  updateTaskStatus(taskId, status, updateTime) {
    try {
      const stmt = db.prepare(
...
//# sourceMappingURL=database-DeitMNJt.js.map
